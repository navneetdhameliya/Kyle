...
import 'package:kayle/UI/Screens/HomeSection/widget/curved_navigation_bar_item.dart';
import 'package:kayle/UI/Screens/HomeSection/widget/nav_bar_item_widget.dart';
import 'package:kayle/UI/Screens/HomeSection/widget/nav_custom_painter.dart';
              ...
              child: Row(
                children: widget.items.map((item) {
                  return NavBarItemWidget(
                    onTap: _buttonTap,
                    selected: Get.put(HomeController()).currentPage.value==widget.items.indexOf(item),
                    position: _pos,
                    length: _length,
