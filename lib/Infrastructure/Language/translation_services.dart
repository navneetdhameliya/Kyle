...
class TranslationService extends Translations {
  static Locale getDeviceLocalLanguage(){
    if(preferences?.getBool(StorageConstants.deviceLanguage) != null && preferences?.getBool(StorageConstants.deviceLanguage) == true){
      String? languageCode = TranslationService.langs.contains(Get.deviceLocale!.languageCode)?Get.deviceLocale!.languageCode:"en";
      ...
      return getLocaleLang(preferences?.getString(StorageConstants.language) ?? "en");
    }
  }

  static getTranslateToLanguage(){
    if(preferences?.getBool(StorageConstants.translateToDeviceLanguage) != null && preferences?.getBool(StorageConstants.translateToDeviceLanguage) == true){
      String? languageCode = TranslationService.langs.contains(Get.deviceLocale?.languageCode)?Get.deviceLocale?.languageCode:"en";
      preferences?.setString(StorageConstants.translateToLanguage, languageCode ?? "en");
